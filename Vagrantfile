...
#    ansible.playbook = "blahsoe.yml"
#  end

  # config.ssh.port = 5001
  ...
  config.vm.define "borgnana", primary: true do |borgnana|
    borgnana.vm.network :private_network, ip: "192.168.99.100"
    borgnana.vm.hostname = "borgnana"
  ...
  config.vm.define "controller" do |controller|
    ...
    controller.vm.provision "shell", privileged: false, inline: <<-EOF
      if [ ! -f /home/vagrant/.ssh/id_rsa ]; then
        cp /vagrant/.vagrant/machines/borgnana/virtualbox/private_key /home/vagrant/.ssh/id_rsa
